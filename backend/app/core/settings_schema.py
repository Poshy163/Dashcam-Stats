...
SETTINGS: tuple[SettingDef, ...] = (
    ...
    SettingDef(
        ...
        "",
        "ingest",
        "Posted to when a transfer starts, finishes or fails. Blank disables it.",
        requires="ingest.enabled",
    ),
    SettingDef(
        "ingest.mqtt_enabled",
        ...
        False,
        "ingest",
        "Publishes backup state to a standard MQTT broker.",
        requires="ingest.enabled",
    ),
    SettingDef(
        "ingest.mqtt_host",
